    ...
    registerEvent: function () {
        ...
        $('#btnSaveC').off('click').on('click', function () {
            ...
            if ($('#frmXemNhanVien').valid()) {
                khachHangController.updateNhanVien(id);
            }
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result == true) {
                        ...
                        khachHangController.deleteNhanVien(id);
                    } else {
                        khachHangController.notify("Không xóa nhân viên uống này !!!");
                    }
                }
            });
        });
        ...
        $('#btnSearch').off('click').on('click', function () {
            khachHangController.search(true);
        });
    ...
    deleteKhachHang: function (id) {
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    khachHangController.notify("Xóa thành công !!!");
                    khachHangController.loadData(true);
                }
                else {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    khachHangController.notify("Cập nhật nhân viên thành công !!!");
                    khachHangController.loadData(true);
                }
                else {
                    alert(response.message);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    khachHangController.notify("Thêm mới nhân viên thành công !!!");
                    khachHangController.loadData(true);
                }
                else {
                    alert(response.message);
